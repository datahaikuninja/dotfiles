...
### PATH
export PATH="/usr/local/bin:/opt/homebrew/bin:/opt/homebrew/Cellar/git:${HOME}/.asdf/shims/python:${HOME}/sdk/go1.21.10/bin:${HOME}/go/bin:${HOME}/.cargo/bin:/Applications/WezTerm.app/Contents/MacOS/wezterm:/opt/homebrew/opt/mysql-client@8.0/bin:/opt/homebrew/opt/mysql-client@5.7/bin:${HOME}/.asdf/shims/ruby:$PATH"
